...
<div id="sb-site">
    <div class="sb-slidebar bg-black sb-left sb-style-overlay">
        <div class="scrollable-content scrollable-slim-sidebar">
            <div class="pad10A">
                ...
                <ul class="chat-box">
                    <li>
                        <div class="status-badge"><img alt="" class="img-circle" src="{{url('/admin-assets/image-resources/people/testimonial1.jpg')}}" width="40">
    ...
    <div class="sb-slidebar bg-black sb-right sb-style-overlay">
        <div class="scrollable-content scrollable-slim-sidebar">
            <div class="pad15A">
                <a class="popover-title" data-target="#sidebar-toggle-1" data-toggle="collapse" href="#" title="">Cloudstatus <span class="caret"></span></a>
                ...
                <a class="popover-title" data-target="#sidebar-toggle-3" data-toggle="collapse" href="#" title="">Tasksfor today <span class="caret"></span></a>
            ...
            <div id="page-content">
                <div id="page-header">
                    <div id="header-nav-left">
                        <a class="header-btn" href="lockscreen-3.html" id="logout-btn"
                        ...
                        <div class="user-account-btn dropdown">
                            <a class="user-profile clearfix" data-toggle="dropdown" href="#" title="My Account">
                                ...
                                <span>Michael Lee</span> <i class="glyph-icon icon-angle-down"></i></a>
                            <div class="dropdown-menu float-right">
                                <div class="box-sm">
                                    <div class="login-box clearfix">
                                        <div class="user-img">
                                            <a class="change-img" href="#" title="">Change photo</a> <img src="{{url('/admin-assets/image-resources/gravatar.jpg')}}">
                                        </div>

                                        <div class="user-info">
                                            <span>Michael Lee <i>UX/UI developer</i></span> <a href="#" title="Edit profile">Edit
                                                profile</a> <a href="#" title="View notifications">View notifications</a>
                                        </div>
                                    </div>
                    ...
                    <div id="header-nav-right">
                        ...
                        <div class="hide" id="popover-search">
                            <div class="pad5A box-md">
                                <div class="input-group">
                                    <input class="form-control" placeholder="Search terms here ..." type="text"> <span class="input-group-btn"><a class="btn btn-primary" href="#">Search</a></span></div>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu float-left">
                                <div class="box-sm">
                                    <div class="pad5T pad5B pad10L pad10R dashboard-buttons clearfix">
                                        <a class="btn vertical-button hover-blue-alt" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-dashboard opacity-80 font-size-20"></i></span>
                                            Dashboard</a>
                                        <a class="btn vertical-button hover-green" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-tags opacity-80 font-size-20"></i></span>Widgets</a>
                                        <a class="btn vertical-button hover-orange" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-fire opacity-80 font-size-20"></i></span>Tables</a>
                                        <a class="btn vertical-button hover-orange" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-bar-chart-o opacity-80 font-size-20"></i></span>Charts</a>
                                        <a class="btn vertical-button hover-purple" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-laptop opacity-80 font-size-20"></i></span>Buttons</a>
                                        <a class="btn vertical-button hover-azure" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-code opacity-80 font-size-20"></i></span>Panels</a>
                                    </div>

                                    <div class="divider"></div>

                                    <div class="pad5T pad5B pad10L pad10R dashboard-buttons clearfix">
                                        <a class="btn vertical-button remove-border btn-info" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-dashboard opacity-80 font-size-20"></i></span>Dashboard</a>
                                        <a class="btn vertical-button remove-border btn-danger" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-tags opacity-80 font-size-20"></i></span>Widgets</a>
                                        <a class="btn vertical-button remove-border btn-purple" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-fire opacity-80 font-size-20"></i></span>Tables</a> <a class="btn vertical-button remove-border btn-azure" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-bar-chart-o opacity-80 font-size-20"></i></span>Charts</a>
                                        <a class="btn vertical-button remove-border btn-yellow" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-laptop opacity-80 font-size-20"></i></span>Buttons</a>
                                        <a class="btn vertical-button remove-border btn-warning" href="#" title=""><span class="glyph-icon icon-separator-vertical pad0A medium"><i class="glyph-icon icon-code opacity-80 font-size-20"></i></span>Panels</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="hdr-btn sb-toggle-left" href="#" id="chatbox-btn" title="Chat sidebar"><i class="glyph-icon icon-linecons-paper-plane"></i></a>
                        <div class="dropdown" id="notifications-btn">
                            ...
                            <div class="dropdown-menu box-md float-left">
                                ...
                                <div class="button-pane button-pane-alt pad5T pad5L pad5R text-center"><a class="btn btn-flat btn-primary" href="#" title="View all notifications">View all notifications</a></div>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu pad0A box-sm float-left" id="progress-dropdown">
                                <div class="scrollable-content scrollable-slim-box">
                                    <ul class="no-border progress-box progress-box-links">
                                        <li>
                                            <a href="#" title=""><div class="progress-title">Finishing uploading files <b>23%</b></div>
                                                <div class="progressbar-smaller progressbar" data-value="23">
                                                    <div class="progressbar-value bg-blue-alt"><div class="progressbar-overlay"></div></div>
                                                </div>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" title=""><div class="progress-title">Roadmap progress <b>91%</b></div>
                                                <div class="progressbar-smaller progressbar" data-value="91"><div class="progressbar-value bg-red">
                                                        <div class="progressbar-overlay"></div></div>
                                                </div>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" title=""><div class="progress-title">Images upload <b>58%</b></div>
                                                <div class="progressbar-smaller progressbar" data-value="58">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-3">
                                <a class="tile-box tile-box-shortcut btn-danger" href="#" title="Example tile shortcut"><span class="bs-badge badge-absolute">1</span>
                            ...
                            <div class="col-md-3">
                                <a class="tile-box tile-box-shortcut btn-success" href="#" title="Example tile shortcut">
                            ...
                            <div class="col-md-3">
                                <a class="tile-box tile-box-shortcut btn-info" href="#" title="Example tile shortcut"><span class="bs-badge badge-absolute">2</span>
                            ...
                            <div class="col-md-3">
                                <a class="tile-box tile-box-shortcut btn-warning" href="#" title="Example tile shortcut">
                        ...
                        <div class="panel mrg20T">
                            <div class="panel-body"><h3 class="title-hero">Weekly Sales</h3>
                                <div class="example-box-wrapper"><div class="mrg20B" id="data-example-1" style="width: 100%; height: 300px"></div></div>
                            </div>
                        </div>

                        <div class="panel-layout">
                            <div class="panel-box col-xs-6">
                                <div class="panel-content bg-white"><canvas height="80" id="icon-cloud" width="80"></canvas></div>

                                <div class="panel-content bg-black">
                                    <div class="center-vertical">
                                        <ul class="center-content nav nav-justified">
                                            <li>
                                                <h4><i class="glyph-icon font-green opacity-80 icon-chevron-down"></i> 7ยบ</h4>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-17.jpg')}}">
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <div class="thumb-overlay bg-black"></div>
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-18.jpg')}}">
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <div class="thumb-overlay bg-black"></div>
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-19.jpg')}}">
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <div class="thumb-overlay bg-black"></div>
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-20.jpg')}}">
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <div class="thumb-overlay bg-black"></div>
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-23.jpg')}}">
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumbnail-box-wrapper mrg5A">
                                                <div class="thumbnail-box">
                                                    ...
                                                    <div class="thumb-overlay bg-black"></div>
                                                    <img alt="" src="{{url('/admin-assets/image-resources/stock-images/img-24.jpg')}}">
                                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="dashboard-box dashboard-box-chart bg-white content-box">
                            ...
                            <div class="button-pane">
                                ...
                                <a class="btn btn-primary float-right tooltip-button" data-placement="top" href="#" title="View details"><i class="glyph-icon icon-caret-right"></i></a>
                            </div>
                        </div>

                        <div class="content-box">
                            <h3 class="content-box-header bg-default">
                                <i class="glyph-icon icon-cog"></i> Live server status<span class="header-buttons-separator"><a class="icon-separator remove-button" data-animation="flipOutX" href="#"><i class="glyph-icon icon-times"></i></a></span>
                            </h3>
                            ...
                            <div class="content-box-wrapper pad0A">
                                ...
                                <table class="table remove-background">
                                    <tbody>
                                    <tr>
                                        <td class="text-left size-sm"><div class="badge mrg10L badge-small mrg5R bg-azure"></div>New user registrations</td>
                                        <td class="text-right">
                                            <a class="btn btn-sm hover-yellow tooltip-button" data-placement="top" href="#" title="Flag"><i class="glyph-icon icon-flag"></i></a>
                                            <a class="btn btn-sm hover-blue-alt tooltip-button" data-placement="top" href="#" title="Edit"><i class="glyph-icon icon-edit"></i></a>
                                            <a class="btn btn-sm hover-red tooltip-button" data-placement="top" href="#" title="Remove"><i class="glyph-icon icon-remove"></i></a>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td class="text-left size-sm"><div class="badge mrg10L badge-small mrg5R bg-orange"></div>Returning visitors</td>
                                        <td class="text-right">
                                            <a class="btn btn-sm hover-yellow tooltip-button" data-placement="top" href="#" title="Flag"><i class="glyph-icon icon-flag"></i></a>
                                            <a class="btn btn-sm hover-blue-alt tooltip-button" data-placement="top" href="#" title="Edit"><i class="glyph-icon icon-edit"></i></a>
                                            <a class="btn btn-sm hover-red tooltip-button" data-placement="top" href="#" title="Remove"><i class="glyph-icon icon-remove"></i></a>
                                    ...
                                    <tr>
                                        <td class="text-left size-sm"><div class="badge mrg10L badge-small mrg5R bg-gray"></div>Page views</td>
                                        <td class="text-right">
                                            <a class="btn btn-sm hover-yellow tooltip-button" data-placement="top" href="#" title="Flag"><i class="glyph-icon icon-flag"></i></a>
                                            <a class="btn btn-sm hover-blue-alt tooltip-button" data-placement="top" href="#" title="Edit"><i class="glyph-icon icon-edit"></i></a>
                                            <a class="btn btn-sm hover-red tooltip-button" data-placement="top" href="#" title="Remove"><i class="glyph-icon icon-remove"></i></a>
                                    ...
                                    <div class="timeline-box timeline-box-left">
                                        <div class="tl-row">
                                            <div class="tl-item float-right">
                                                ...
                                                <div class="popover right"><div class="arrow"></div>
                                        ...
                                        <div class="tl-row">
                                            <div class="tl-item float-right">
                                                ...
                                                <div class="popover right"><div class="arrow"></div>
                                                    <div class="popover-content"><div class="tl-label bs-label bg-yellow">Teleconference</div>
                                                        <p class="tl-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.Donec odio.</p>
                                                        <div class="tl-time"><i class="glyph-icon icon-clock-o"></i> a few seconds ago</div>
                                                    </div>
                                                </div>
