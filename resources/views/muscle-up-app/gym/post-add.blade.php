...
@section('content')
    ...
    <div class="container-fluid" style="margin: 0; padding: 0;">
        <div class="trainee-reg clearfix">
            ...
            <form class="post-request" role="form" method="POST" action="{{route('save-medical')}}">
                {{csrf_field()}}
                <section>
                    ...
                    <div class="t-reg-form">
                        ...
                        <div class="reg-form">
                            <div class="fields clearfix">
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12 text-field">
                                    <input type="num_Instructor" name="num_Instructors" value="{{old('num_Instructors')}}" placeholder="Current Number of Instructors...">
                                </div>
                                <div class="form-group col-md-6 col-sm-12 col-xs-12 text-field">
                                    <input class="num_Trainee" type="number" name="num_Trainee" value="{{old('num_Trainee')}}" placeholder="Current Number of Trainees...">
                                </div>
