                    ...
                    <div class="reg-form">
                        <form id="contact-form" method="post" action="#">
                            <div class="fields clearfix">
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12 text-field">
                                    <input class="birth-date" type="text" data-field="date" name="birth-date" value="" placeholder="Date of Birth..." readonly>
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12 text-field">
                                    ...
                                    <div class="form-group col-md-3 col-sm-3 col-xs-3">
                                        <label>Male: <input class="male-option" type="radio" name="sex-options" value=""> </label>

                                    </div>
                                    <div class="form-group col-md-3 col-sm-3 col-xs-3">
                                        <label for="female-option">Female: <input class="female-option" type="radio" name="sex-options" value=""> </label>
                            ...
                            <div class="address-field">
                                <textarea name="address" placeholder="Type Your Message Here"></textarea>
                            </div>

                            <div class="text-right col-md-12"><button type="submit"><span class="fa fa-angle-right"></span> Register</button></div>
                        </form>
                    </div>
                </div>
