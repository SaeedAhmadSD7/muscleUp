...
<div class="topbar">
    <div class="topbar-left">
        <div class="logo">
            <h1><a href="#"><img src="{{ asset('admin-panel-assets/img/logo.png') }}" alt="Logo"></a></h1>
        </div>
                        ...
                        <ul class="dropdown-menu dropdown-message">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="{{ asset('admin-panel-assets/img/general/users/chat/2.jpg') }}" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
{{--                                    <img src="{{ asset('genral') }}" class="xs-avatar ava-dropdown" alt="Avatar">--}}
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="{{ asset('admin-panel-assets/img/general/users/chat/3.jpg') }}" class="xs-avatar ava-dropdown" alt="Avatar">
                    ...
                    <li class="dropdown topbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src=""></span> Jane <strong>Doe</strong> <i class="fa fa-caret-down"></i></a>
