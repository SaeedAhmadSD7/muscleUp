<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        ...
        <div class="profile-info">
            <div class="col-xs-4">
                <a href="profile.html" class="rounded-image profile-image"><img src="{{ asset('admin-panel-assets/img/general/users/user-100.jpg') }}"></a>
            </div>
            <div class="col-xs-8">
        ...
        <div id="sidebar-menu">
            <ul>
                <li class='has_sub'>
                    ...
                    <ul>
                        <li>
                            <a href='' class="{{ Request::is('admin/home') ? 'active' : '' }}"><span>Dashboard</span></a>
                        </li>
                        <li><a href='#'><span>Dashboard v2</span></a></li>
                    </ul>
                </li>
                <li class='has_sub'>
                ...
                <li class='has_sub'>
                    <a href='javascript:void(0);'><i class='fa fa-table'></i><span>Users</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                    <ul>
                        <li><a href="" class="{{ Request::is('user/list') ? 'active' : '' }}"><span>All Users</span></a></li>
                        <li><a href='datatables.html'><span>Datatables</span></a></li>
                    </ul>
                </li>
                <li class='has_sub'>
                    <a href='javascript:void(0);'><i class='fa fa-map-marker'></i><span>HashTags</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                    <ul>
                        <li><a href="" class="{{ Request::is('hash-tags') ? 'active' : '' }}"><span>All Hashtags</span></a></li>
                        <li><a href='vector-maps.html'><span>Vector Maps</span></a></li>
                    </ul>
                </li>
                <li class='has_sub'>
                    <a href='javascript:void(0);'><i class='fa fa-envelope'></i><span>Email</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                    <ul>
                ...
                <li class='has_sub'>
                    <a href='javascript:void(0);'><i class='icon-megaphone'></i><span>Extras</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                    <ul>
