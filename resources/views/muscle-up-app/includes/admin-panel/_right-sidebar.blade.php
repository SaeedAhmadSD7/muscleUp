                        ...
                        <div id="chat-coll" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <ul class="list-unstyled" id="chat-list">
                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/1.jpg') }}"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
{{--                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('assets/img/general') }}"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>--}}
                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/3.jpg') }}"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg">Where is my mind</span></a></li>
                                    <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/4.jpg') }}"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
                                    <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/5.jpg') }}"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
                                    <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/6.jpg') }}"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default" id="chat-panel">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <ul class="list-unstyled" id="chat-list">
                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/1.jpg') }}"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
{{--                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('general') }}"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>--}}
{{--                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('general') }}"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>--}}
                                    <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/3.jpg') }}"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg" title="Eminem - The Monster ft. Rihanna"><i class="icon-play"></i> Eminem - The Monster ft. Rihanna</span></a></li>
{{--                                    <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="{{ asset('genral') }}"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>--}}
                                    <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general/users/chat/5.jpg') }}"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
{{--                                    <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{ asset('admin-panel-assets/img/general') }}"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>--}}
                                </ul>
                            </div>
                        </div>
                    </div>
