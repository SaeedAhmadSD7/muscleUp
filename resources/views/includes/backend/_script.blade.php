...
<script src="{{url('/assets/js/message_detail.js')}}"></script>
<script src="{{url('/admin-assets/widgets/chosen/chosen.js')}}"></script>
<script src="{{url('/admin-assets/widgets/chosen/chosen-demo.js')}}"></script>
<script src="{{url('/admin-assets/widgets/textarea/textarea.js')}}"></script>
<script src="{{url('/assets/js/message_detail.js')}}"></script>
<script src="{{url('/assets/js/delete-trainee.js')}}"></script>
<script src="{{url('/admin-assets/js/diet.js')}}"></script>
<script src="{{url('/assets/js/trainee-inbox.js')}}" type="text/javascript"></script>

<script>
    $(function () {
        $('.sidebar-submenu').addClass('closed-sidebar');
    });
</script>
