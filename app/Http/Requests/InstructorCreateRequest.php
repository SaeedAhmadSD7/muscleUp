...
class InstructorCreateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'email.email' => 'Entered Value should be an Email address.Please enter Correct type of Email address',
            'email.unique' => 'Entered Email address is already taken.Please enter another Email Address',
            ...
            'joining_salary.required' => 'Joining Salary is Required.Please select a Previous Salary',
            'joining_salary.numeric' => 'Entered Joining salary is not numeric value.Please enter a Numeric Amount',
